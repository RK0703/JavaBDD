...
import com.FrontierX.PageObjRepo.HomePageObj;
...
//switch to new tab
	...
	public void VerifyTodaysActivityIsDisplayed(String Exp)
	{
		...
		Assert.assertTrue(FirstRecSubTitle().getText().contains(FxUtilities.getCurrentDateInSpecificFormat(cal)),"Today's Activity is Synced");
	...
	public void VerifyTodaysRhythmValue (String Title,String NRV)
	{
		...
		Assert.assertEquals(NormalRhythm, NRV);
	}
...
public void ReadSearchedActivity(String expectedSearchedActivityName)
	...
	public void ClickOnTermsOfUseLink()
	{
		...
		FxUtilities.SwitchTab(1, driver);
	...
	{
		FxUtilities.WaitForVisibilityOfElement(driver, "className", "current-user-dashboard");
	}
