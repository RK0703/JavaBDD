...
//import com.FrontierX.Utilities.FxEnums;
 ...
 public abstract class Settings 
{
	...
	protected static String StageURL = "https://app.frontierxs.com/#/login";
	protected static String ProdURL = "https://app.frontierxapp.com/#/login";
	protected static String Environment = FxUtilities.getOperatingSystemSystemUtils();
	...
	public static WebDriver DecideEnvironment(String env)
	{
	    ...
	    {				
			...
			else
			{
				...
				driver = new ChromeDriver(options);
				driver.get(StageURL);
				System.out.println("Launching 2.0 Stage Fx Web Page in ubuntu ec2");
				driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
